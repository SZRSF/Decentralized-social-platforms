...
<template>
  <div class="content">
    <div class="left">
      ...
      <div class="post-type">
        <input type="text" class="post-type-value" placeholder="选择一个家" v-model="selectFamily.name" @click="showFamily()"/>
        <ul class="post-type-options" v-show="showFamilyList">
...
export default {
  ...
  methods: {
    ...
    selected(index) {
      this.selectFamily = this.familyList[index];
