...
(function () {
    ...
    var global$3 = tinymce.util.Tools.resolve('myTinymce.dom.DOMUtils');
    ...
    var global$1 = tinymce.util.Tools.resolve('myTinymce.util.ImageUploader');

    var global = tinymce.util.Tools.resolve('myTinymce.util.Tools');
