...
(function () {
    ...
    var global$1 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.Resource');

    const DEFAULT_ID = 'myTinymce.plugins.emoticons';
