...
(function () {
    ...
    var global$5 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
    ...
    var global$4 = tinymce.util.Tools.resolve('myTinymce.util.Tools');
    ...
    var global$3 = tinymce.util.Tools.resolve('myTinymce.dom.TreeWalker');

    var global$2 = tinymce.util.Tools.resolve('myTinymce.util.URI');
    ...
    var global$1 = tinymce.util.Tools.resolve('myTinymce.util.Delay');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.util.VK');
