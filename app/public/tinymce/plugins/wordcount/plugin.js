...
(function () {
    ...
    var global$2 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
    ...
    var global$1 = tinymce.util.Tools.resolve('myTinymce.dom.TreeWalker');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.util.Delay');
