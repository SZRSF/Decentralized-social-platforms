...
(function () {
    ...
    var global$3 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
...
<p>When a tabbed dialog is opened, the first button in the tab menu is focused. Pressing tab will navigate to the first interactive component in that tab, and will cycle through the tab\u2019s components, the footer buttons, then back to the tab button. To switch to another tab, focus the tab button for the current tab, then use the arrow keys to cycle through the tab buttons.</p>`;
    ...
    var global$2 = tinymce.util.Tools.resolve('myTinymce.Env');
    ...
    var global$1 = tinymce.util.Tools.resolve('myTinymce.util.I18n');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.EditorManager');
    ...
    const tab = () => {
      ...
      const changeLogLink = '<a href="https://www.tiny.cloud/docs/myTinymce/6/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=myTinymce" rel="noopener" target="_blank">TinyMCE ' + version + '</a>';
      const htmlPanel = {
        type: 'htmlpanel',
