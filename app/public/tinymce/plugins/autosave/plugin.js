...
(function () {
    ...
    var global$4 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
    ...
    var global$3 = tinymce.util.Tools.resolve('myTinymce.util.Delay');

    var global$2 = tinymce.util.Tools.resolve('myTinymce.util.LocalStorage');
    ...
    const register$1 = editor => {
      ...
      registerOption('autosave_prefix', {
        processor: 'string',
        default: 'myTinymce-autosave-{path}{query}{hash}-{id}-'
      });
