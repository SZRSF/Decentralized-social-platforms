...
(function () {
    ...
    var global$5 = tinymce.util.Tools.resolve('myTinymce.util.Tools');

    var global$4 = tinymce.util.Tools.resolve('myTinymce.dom.DOMUtils');

    var global$3 = tinymce.util.Tools.resolve('myTinymce.html.DomParser');
    ...
    var global$2 = tinymce.util.Tools.resolve('myTinymce.html.Node');

    var global$1 = tinymce.util.Tools.resolve('myTinymce.html.Serializer');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.Env');
