...
(function () {
    ...
    var global$6 = tinymce.util.Tools.resolve('myTinymce.PluginManager');
    ...
    var global$5 = tinymce.util.Tools.resolve('myTinymce.dom.RangeUtils');

    var global$4 = tinymce.util.Tools.resolve('myTinymce.dom.TreeWalker');

    var global$3 = tinymce.util.Tools.resolve('myTinymce.util.VK');
    ...
    var global$2 = tinymce.util.Tools.resolve('myTinymce.dom.DOMUtils');

    var global$1 = tinymce.util.Tools.resolve('myTinymce.util.Tools');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.dom.BookmarkManager');
