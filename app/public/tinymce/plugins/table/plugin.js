...
(function () {
    ...
    var global$2 = tinymce.util.Tools.resolve('myTinymce.util.Tools');
    ...
    var global = tinymce.util.Tools.resolve('myTinymce.FakeClipboard');

    const tableTypeBase = 'x-myTinymce/dom-table-';
